...
<nav id="mainnav-container">
	<div id="mainnav">
		...
		<div id="mainnav-menu-wrap">
				...
				<div class="nano-content">
					...
					<div id="mainnav-profile" class="mainnav-profile">
						<div class="profile-wrap text-center">
							<div class="pad-btm">
								<img class="img" src="<?php echo $RouteViewAssets."nifty/img/bg-img/cooservipress.jpg"; ?>" alt="Profile Picture" width="190" height="80"
								 alt="User" style="border-radius:5px">
							</div>
					...
					<ul id="mainnav-menu" class="list-group">
						...
						<?php  
	        if($objFunciones->validarFuncion( $_SESSION['rol'],16) == 1){
	                echo "<li>
					            <a href='#' >
	                        ...
	                        if($objFunciones->validarFuncion( $_SESSION['rol'],1) == 1){
	                        echo" <li>
	                        ...
	                        if($objFunciones->validarFuncion( $_SESSION['rol'],2) == 1){
		                    echo   "<li>
	                        ...
	                        if($objFunciones->validarFuncion( $_SESSION['rol'],3) == 1){
			                echo "  <li>
			                            <a href='".$RouteViewApp."module/sucursales/index.php' ><i class='fa fa-building '></i>Sucursales
						                </a>
					                </li>";
		                    }
			               echo "</ul>
	        ...
	        if($objFunciones->validarFuncion( $_SESSION['rol'],4) == 1){
		        echo "<li>
		    ...
		    if($objFunciones->validarFuncion( $_SESSION['rol'],5) == 1){	
				echo "<li>
							<a href='#'  >
...
?>
                       ...
                       if($objFunciones->validarFuncion( $_SESSION['rol'],5) == 1)
						{
							echo "<li><a href='".$RouteViewApp."module/credito/index.php' i><i class='fa fa fa-calendar-check-o'></i>Listado de creditos</a>
							</li>";
						}	
					if($objFunciones->validarFuncion( $_SESSION['rol'],17) == 1)
						{
							echo "<li><a href='".$RouteViewApp."module/credito/solicitud.php' ><i class='fa fa-line-chart'></i>Solicitud de credito</a>
								</li>";
						}
						
                        if($objFunciones->validarFuncion( $_SESSION['rol'],18) == 1)
						{
							echo "<li><a href='".$RouteViewApp."module/credito/simulador.php' ><i class='fa fa-sliders'></i>Simulador</a>
							</li>";
						}	
	                echo"</ul>
	            </li>";

<?php session_start();
 ...
 require_once(PROVIDER_PATH."sucursalController.php");
        ...
        <div class="hk-pg-wrapper bg-white" style="min-height: 587px;"  >
            ...
            <div class="container mt-xl-50 mt-sm-30 mt-15 ">
                <div class="hk-pg-header align-items-top">
                    <div>
                        <h2 class="hk-pg-title font-weight-600 mb-10">Listado de sucursales registradas.</h2>
                    </div>
                        ...
                        <div class="col-sm">
                            <div class="table-wrap">
                                                ...
                                                <div class="col-auto">
                                                    <a href="<?php echo  PLATFORM_SERVER."modules/sucursales/agregar.php";
                                                        ?>" target="_self" class="btn btn-gradient-info mb-2 btn-sm"><i
                                                            class="fa fa-archive fa-2x"></i> Crear
                                                        nueva sucursal</a>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div id="tablaDinamica">
                                    <?php sucursalController::listaSucursales();?>
                                </div>
                            </div>
                        </div>
                    </div>

					...
					<div class="row">
						<div class="col-xl-12">
							<section class="hk-sec-wrapper">
								...
								<p class="mb-25">Desde aqui puede ver un resumen del estado de su
									plataforma.<br>Recuerde que al presionar en la opcion se desplega en panel ,recuerde
									volver a presionar para cerrar si desea ver otra opcion</p>
								<div class="row">
									<div class="col-sm">
										<div class="button-list mb-15">
											<a class="btn btn-gradient-primary collapsed" data-toggle="collapse"
												href="#medicamentos" role="button" aria-expanded="false"
												aria-controls="collapseExample">
												<li class="fa fa-pills"></li> Medicamentos
											</a>
											<button class="btn btn-gradient-primary collapsed" type="button"
												data-toggle="collapse" data-target="#collapseExample"
												aria-expanded="false" aria-controls="collapseExample">
												<li class="fa fa-pills"></li> Facturas
											</button>
											<button class="btn bbtn btn-gradient-primary collapsed" type="button"
												data-toggle="collapse" data-target="#collapseExample"
												aria-expanded="false" aria-controls="collapseExample">
												<li class="fa fa-pills"></li> Afiliados
											</button>
											<button class="btn bbtn btn-gradient-primary collapsed" type="button"
												data-toggle="collapse" data-target="#accesos" aria-expanded="false"
												aria-controls="collapseExample">
												<li class="fa fa-th-large"></li> Accesos directos
											</button>
											<button class="btn bbtn btn-gradient-primary collapsed" type="button"
												data-toggle="collapse" data-target="#administrativas"
												aria-expanded="false" aria-controls="collapseExample">
												...
												<div class="w-1024p">
													<div class="col-auto">
														<div class="custom-control ">
															<label class=""> <i
																	class='fa fa-sort-numeric-up fa-2x '></i>
																.</label>
														</div>
													</div>
													<div class="col-auto">
													...
													<div class="col-auto">
														<div class="custom-control ">
															<label class=""> <i class='fa fa-clipboard-list fa-2x '></i>
																.</label>
														</div>
													</div>
													<div class="col-auto">
														<div class="input-group mb-2">
															<select class="form-control custom-select d-block w-150"
																...
																<option value="tmin">Stock <= minimo </option> <option
																		value="tzero">Stock 0 </option>
															</select>
														</div>
													</div>
													<div class="col-auto">
													...
													<div class="col-auto">
														<div class="input-group mb-2">
															<select class="form-control custom-select d-block w-150"
																id="venta" name="venta">
																<option value="vt">Producto : Venta </option>
																<option value="vn">Venta normal</option>
																<option value="va">Venta Afiliados</option>
															...
															<div class="col-lg-2 col-md-2 col-sm-12 mb-30">
																<div class="card">
																	...
																	<div class="card-body">
																		...
																		<p class="card-text ">Modulo de caja
																			registradora y ticket.</p>
																		<a href="#" class="btn btn-gradient-primary"><i
																				class="fa fa-cart-plus fa-5x"></i> </a>
																	</div>
															...
															<div class="col-lg-2 col-md-2 col-sm-12 mb-30">
																<div class="card">
																	...
																	<div class="card-body">
																		...
																		<p class="card-text text-justify">Modulo de
																			contable y facturacion.</p>
																		<a href="#" class="btn btn-gradient-primary"><i
																				class="fa fa-balance-scale fa-5x"></i>
																		</a>
																	</div>
																	<div class="card-footer text-muted text-justify">
																		Modulo principal
															...
															<div class="col-lg-2 col-md-2 col-sm-12 mb-30">
																<div class="card">
																	...
																	<div class="card-body">
																		...
																		<p class="card-text ">gestion de Proveedores.
																		</p>
																		<a href="#" class="btn btn-gradient-primary"><i
																				class="fa fa-clipboard-list fa-5x"></i>
																		</a>
																	</div>
															...
															<div class="col-lg-2 col-md-2 col-sm-12 mb-30">
																<div class="card">
																	...
																	<div class="card-body">
																		...
																		<p class="card-text ">Logistica e inventario
																			&nbsp;</p>
																		<a href="#" class="btn btn-gradient-primary"><i
																				class="fa fa-boxes fa-5x"></i> </a>
																	</div>
																	<div class="card-footer text-muted ">
																		Modulo principal
																	</div>
															...
															<div class="col-lg-2 col-md-2 col-sm-12 mb-30">
																<div class="card">
																	...
																	<div class="card-body">
																		...
																		<p class="card-text ">gestion de consultorio
																			&nbsp;</p>
																		<a href="#" class="btn btn-gradient-primary"><i
																				class="fa fa-user-md fa-5x"></i> </a>
																	</div>
																	<div class="card-footer text-muted ">
																		Modulo principal
																	</div>
										...
										<div class="collapse" id="administrativas" style="">
											<div class="card card-body">
												<section class="hk-sec-wrapper">
													<h5 class="hk-sec-title mb-25">Estadisticas administrativas y de
														recursos humanos :
															...
															<div class="row">
																...
																<div class="col-md-6">
																	<ul class="list-group">
																		...
																		<li
																			class="list-group-item d-flex justify-content-between align-items-center">
																			Administrativa y otros cargos logisticos<i
																				class="text-light font-22"></i> 0
																		</li>
																		<li
																			class="list-group-item d-flex justify-content-between align-items-center">
																			Clientes afiliados <i
																				class="text-light font-22"></i> 0
																		</li>
												...
												<div class="row">
													<div class="col-md-6">
														<ul class="list-group mb-15">
															<li
																class="list-group-item d-flex justify-content-between align-items-center">
																Medicamentos registrados <i
																	class="text-light font-22"></i>
																<?php echo productoController::nproductos(); ?>
															</li>
															<li
																class="list-group-item d-flex justify-content-between align-items-center">
																Medicamentos con lotes de vencimiento <i
																	class="text-light font-22"></i>0
															</li>
															<li
																class="list-group-item d-flex justify-content-between align-items-center">
																Medicamentos con lote minimo o 0<i
																	class="text-light font-22"></i>0
															</li>
														</ul>
													</div>
													<div class="col-md-6">
														<ul class="list-group">
															...
															<li
																class="list-group-item d-flex justify-content-between align-items-center">
																Clientes afiliados <i class="text-light font-22"></i>H -
																0 , BD - 0
															</li>

...
include_once(PROVIDER_PATH."rolFuncionesController.php");
$objrolFunciones = new rolFuncionesController();
$objSucursal = new sucursalController();
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div id="example-basic">
                                    ...
                                    <div class="col-xl-8 mb-20">
                                        <form>
                                            ...
                                            <div class="form-group">
                                                <?php sucursalController::selectSucursal(); ?>
                                            </div>
                                            <div class="form-group">
                            ...
                            <h3>
                                <span class="wizard-icon-wrap"><i class="fa fa-user-shield"></i></span>
                                <span class="wizard-head-text-wrap">
    ...
    <script src="<?php echo JS_SERVER.'usuario/form-wizard-data.js'; ?>"></script>
    ...
    <script src="<?php echo JS_SERVER.'localidad/module.js';  ?>"></script>

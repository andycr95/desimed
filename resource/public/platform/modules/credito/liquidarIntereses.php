...
if(floatval($imArray['interesesAtrasados']) >0){
    ...
    <span class='alert-icon-wrap'><i class='zmdi zmdi-check-circle'></i></span> Estado del credito a tiempo.
                                ...
                                <div class="col-auto">
                                    ...
                                    <div class="col-md-12 ">
                                        <div class="form-inline">
                                            <div class="form-row align-items-center">
                                                <div class="col-auto">
                                                    <a href="#" id="" target="_self" class="btn btn-gradient-info mb-2 btn-lg"><i
                                ...
                                <div class="col-auto">
                                    ...
                                    <div class="col-md-12 ">
                                        <div class="form-inline">
                                            <div class="form-row align-items-center">
                                                <div class="col-auto">
                                                    <a href="#" target="_self" class="btn btn-gradient-info mb-2 btn-lg"><i

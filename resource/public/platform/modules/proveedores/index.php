        ...
        <div class="hk-pg-wrapper bg-white" style="min-height: 587px;"  >
            ...
            <div class="container mt-xl-50 mt-sm-30 mt-15 ">
                <div class="hk-pg-header align-items-top">
                    <div>
                        <h2 class="hk-pg-title font-weight-600 mb-10">Listado de Proveedores registrados.</h2>
                    </div>
                    <div class="w-1024p">
                                ...
                                <div class="col-auto">
                                    <div class="input-group mb-2">
                                        <select class="form-control custom-select d-block w-150" id="estado" name="estado">
                                            <option value="tc">Todos los Proveedores</option>
                                            <option value="ca">Proveedores habilitados</option>
                                            <option value="ci">Proveedores inahabilitados</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-auto">

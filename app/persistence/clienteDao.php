...
class clienteDao
{
    public static function crearCliente(cliente $cliente)
    {
        ...
        discapacidad_desc_beneficiario,  nombre_beneficiario2, sexo_beneficiario2, documento_beneficiario2, parentesco_beneficiario2, discapacidad_beneficiario2,discapaciadad_desc_beneficiario2, nombre_beneficiario3, sexo_beneficiario3, documento_beneficiario3, 
        ...
        VALUES (
            NULL,'Cliente ordinario', NULL, NULL, NULL, :nombre_apellido, :documento, :sexo, :fecha_nacimiento, :direccion,
    ...
    public static function crearClienteAfiliado(cliente $cliente)
    {
        ...
        $sql2 = "INSERT INTO cliente (
            ...
            ets, anemia,pulmonia, otras_cual, estado)
            VALUES (
                NULL,'Afiliado', :idempleado, :registro, :fecha_registro, :nombre_apellido, :documento, :sexo, :fecha_nacimiento, :direccion, :telefono, :celular, :email, :dispacidad, :extracto, :nombre_beneficiario,
                :sexo_beneficiario, :documento_beneficiario, :parentesco_beneficiario, :discapacidad_beneficiario, :discapacidad_desc_beneficiario, :nombre_beneficiario2, :sexo_beneficiario2, :documento_beneficiario2, 
                :parentesco_beneficiario2, :discapacidad_beneficiario2, :discapaciadad_desc_beneficiario2, :nombre_beneficiario3, :sexo_beneficiario3, :documento_beneficiario3, :parentesco_beneficiario3, 
                :discapacidad_beneficiario3, :discapacidad_desc_beneficiario3, :nombre_beneficiario4, :sexo_beneficiario4, :documento_beneficiario4, :parentesco_beneficiario4, :discapacidad_beneficiario4, 
                :discapacidad_desc_beneficiario4, :nombre_afiliacion, :sexo_afiliacion, :documento_afiliacion, :parentesco_afiliacion, :discapacidad_afiliacion, :discapaciadad_desc_afiliacion, :nombre_afiliacion2, 
                :sexo_afiliacion2, :documento_afiliacion2, :parentesco_afiliacion2, :discapacidad_afiliacion2, :discapaciadad_desc_afiliacion2, :diabetes, :hipertension, :enf_cardiacas, :estres, :osteoporosis, :artitis, 
                :cancer, :alergias, :migrana, :ets, :anemia, :pulmonia, :otras_cual, 1)";
        $resultado2 = $data_source->ejecutarActualizacion($sql2, array(
            ':idempleado' => $cliente->getIdasesor(),
